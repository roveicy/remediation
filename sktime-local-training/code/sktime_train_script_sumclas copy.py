...
if __name__ == "__main__":
    ...
    clf = RandomIntervalClassifier(n_jobs=-1)
    ...
    no_of_samples = len(X_test.index)
    pred_time_per_sample = pred_time / no_of_samples

    #Model Evaluation for training set

    #Prediction time
    print(f'PredTimePerSample={pred_time_per_sample}')
